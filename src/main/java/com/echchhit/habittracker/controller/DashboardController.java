...
public class DashboardController {
    ...
    public void initialize() {
        ...
        // Add a listener to handle window maximization/resizing
        weeklyChart.widthProperty().addListener((obs, oldVal, newVal) -> {
    ...
    private void loadHeatmap() {
        ...
        for (int i = 6; i >= 0; i--) {
            ...
            double opacity = (count == 0) ? 1.0 : (maxCompletions == 0 ? 0.6 : 0.3 + (0.7 * ((double) count / maxCompletions)));
    ...
    private void loadWeeklyChart() {
        ...
        // Ensure static symbols are hidden during animation
        ...
        layoutWait.setOnFinished(e -> {
            ...
            // Create a fresh clip rectangle that isn't bound to old width values
                        ...
                        new javafx.animation.KeyFrame(javafx.util.Duration.millis(300),
                                event -> {
                                    ...
                                    if (nextIndex == series.getData().size() - 1) {
                                        ...
                                        // Finalize clip to ensure full visibility after maximize
                                        series.getNode().setClip(null);
                                    }
                                },
